...
export async function ImageRightSmallerImageDetachedTitle({ data, sectionCount }) {
  const { fields } = data
  ...
  return (
    ...
    <div id="history" className="on-scroll-history"> 
      <Section className="relative" bg={bg}>
        <Container width={width} margin="section" className="relative z-1">
          ...
          <div className="mt-6 grid gap-4 md:gap-8 md:mt-8 lg:mt-6 lg:grid-cols-12 xl:gap-x-12">
            <SectionImageVideo
              fields={fields}
              defaults={defaults}
            />
            ...
            <Motion className="lg:col-span-8 lg:row-start-1">
              {/* body */}
